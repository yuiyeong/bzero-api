...
사용법:
    uv run python scripts/seed_active_cities.py
"""
...
def get_seed(timezone: ZoneInfo) -> list[City]:
    ...
    return [
        ...
        City.create(
            ...
            image_url="https://spphmqtqpxauvvgntilq.supabase.co/storage/v1/object/public/images/cities/icon_serensia.webp",
        ...
        City.create(
            ...
            image_url="https://spphmqtqpxauvvgntilq.supabase.co/storage/v1/object/public/images/cities/icon_lorensia.webp",
            base_cost_points=100,
            base_duration_minutes=180,
            is_active=True,
            display_order=2,
