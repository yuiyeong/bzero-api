"""DirectMessageRoomSyncRepository 인터페이스 (동기).

Celery Worker에서 사용하는 동기 버전 리포지토리 인터페이스입니다.
"""
...
class DirectMessageRoomSyncRepository(ABC):
    """DirectMessageRoom 동기 리포지토리 인터페이스.
