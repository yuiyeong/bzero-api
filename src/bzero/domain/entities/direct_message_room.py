...
class DirectMessageRoom:
    ...
    def is_participant(self, user_id: Id) -> bool:
        ...
        Returns:
            user1 또는 user2이면 True
        """
        return user_id.value == self.user1_id.value or user_id.value == self.user2_id.value
    ...
    def can_accept_or_reject(self, user_id: Id) -> bool:
        ...
        Returns:
            user2(수신자)이면 True
        """
        return user_id.value == self.user2_id.value
    ...
    def get_other_user_id(self, user_id: Id) -> Id:
        ...
        """
        if user_id.value == self.user1_id.value:
            return self.user2_id
        if user_id.value == self.user2_id.value:
